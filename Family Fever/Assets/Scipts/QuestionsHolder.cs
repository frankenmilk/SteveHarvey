...
public class QuestionsHolder : MonoBehaviour
{
    ...
    public string Question6 = "In horror movies, name a place teenagers always go when there is a killer on the loose?";
    public string Question2 = "Name the most useful body part that begins with the letter \"L\" ";
    public string Question3 = "Name something you have more of than Steve Harvey?";
    public string Question4 = "Name something people win on game shows?";
    public string Question5 = "Name something a burglar wouldn't want to see when they break into a house";
